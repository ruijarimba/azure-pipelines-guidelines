...
```plaintext
[ADOG-STEPS-001 — AVOID: Using pipeline variables in tasks or steps templates](https://github.com/ruijarimba/azure-pipelines-guidelines/blob/main/guidelines/steps/avoid-pipeline-variables.md)
```
