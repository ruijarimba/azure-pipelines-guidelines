...
- `.github/prompts/add-guideline.prompt.md` — create a new guideline file and add a CHANGELOG entry.
- `.github/prompts/update-guideline.prompt.md` — update an existing guideline file and add a CHANGELOG entry.
